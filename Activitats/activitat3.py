...
for line in file.readlines():
    ...
    for numero in dades:
        ...
        bloc = block.AIR.id
        # POSEU EL CONDICIONAL NECESSARI
...
# completeu la funció perquè retorni el tipus de bloc trepitjat
...
while not start:
    ...
    for e in events:
        ...
        if posicio.x == POS_X-5 and posicio.y == POS_Y and posicio.z == POS_Z-5:
            ...
            mc.postToChat("TROBA FINAL DEL LABERINT!")
    time.sleep(0.5)




# CREEU EL BUCLE DE CONTROL DEL JOC
